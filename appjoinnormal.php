...
<strong><a href="apphome.php">Home/</a><a href="appinsidejoinnormal.php">Join/</a><a href="appjoinnormal.php">NormalJoin/</a></strong>

<form id="menuchoice" action="appjoinnormal.php" method="post">
<font>
Menu
...
<input id="" type="submit" onclick="return confirm('Are you sure you want to Add this ID in JOIN LIST?')" name="submit" value="Submit">
</form>
</div>
</body>
</HTML>
...
include"header1.php";
 ...
 $successmsg="ID SUCCESSFULLY ADDED IN NORMAL JOIN LIST";
    ...
    if(($rowuser[0]==$mid))
    {
     ...
     while ($row=mysqli_fetch_row($search))
     {
      ...
      else if(($row[0]==$mid)&&($row[3]==0)) //found in messjoin but inactive
      {
       ...
       $que2="UPDATE redn_counter SET join_dates='$day',bool=0";
      ...
      else
      {
       ...
       $que1 = "INSERT into join_dates(id,dates) values('$mid','$dd') ";
       $que2="INSERT into redn_counter(id,join_dates,redn_dates,bool) VALUES ('$mid','$day',0,0)"; 
      //mysqli_query($link,$que1);
      mysqli_query($link,$que2);
        if(mysqli_query($link, $sql))
        {
